/*------------------------------------------------------------------------------------------------------/
| Program : ACA ONLOAD CONTACTS.js
...
try {
	...
	if (parentCapIdString != "" && parentCapIdString != "null") {
		...
		if (parentCapId == null) {
			...
			contactsGroup = parentCap.getContactsGroup();
			if (contactsGroup != null) {
				conArr = contactsGroup.toArray();
				logDebug("Found " + conArr.length + " contacts");
				newContactGroup = aa.util.newArrayList();
				for (cIndex in conArr) {
					thisContact = conArr[cIndex];
					if (thisContact.getContactType() != "Attorney" && thisContact.getContactType() != "Agent") {
						thisContact.setCapID(capId);
						newContactGroup.add(thisContact); 
					}
				}
				cap.setContactsGroup(newContactGroup);
